...
- **Type and repositories:** declared in the [[categories/<category>/<project>/AGENTS|project AGENTS]] (`default` | `included` | `multi-repo`, repos and PR branch — see [[TYPES|TYPES]]).
