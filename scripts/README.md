...
| `pop_validate.py` | Validates limits: 144/600 chars in the indexes, ≤150 lines per note (plans ≤200; research `raw/` exempt), card frontmatter, consistent `stage:`, `pop-hash` code-citation annotations (fail-closed — DOX rule 9, [[_templates/DOX]]); warnings: orphan worktrees and broken wikilinks. Exit 1 on violation. |
