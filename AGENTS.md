...
| `update-harness` | Check whether this repo's harness is current with the original PoP and update it respecting the format — git merge for a fork, managed reinstall for an included repo. **Outside the kanban**, always with confirmation before writing. |
...
16. **Worktrees and ownership:** outside a root-local PoP, 004 has one integration worktree per task. An external yolo scope bases its worktree on the current working branch and integrates into it; at scope close the agent **suggests** the PR to `main`, opened only on the user's explicit request, and the merge is always human. Dependencies are prerequisites — [[WORKFLOW|WORKFLOW]].
...
The vault's architecture decisions live in `notes/decisions/`, one note per decision day (`YYYY-MM-DD-harness-decisions.md`) — consult them before proposing harness changes: [[notes/decisions/2026-07-20-harness-decisions|2026-07-20]] · [[notes/decisions/2026-07-22-harness-decisions|2026-07-22]] · [[notes/decisions/2026-08-16-harness-decisions|2026-08-16]] · [[notes/decisions/2026-08-18-harness-decisions|2026-08-18]] · [[notes/decisions/2026-08-23-harness-decisions|2026-08-23]].
