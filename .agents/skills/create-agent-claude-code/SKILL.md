...
```bash
python3 .agents/skills/create-agent-claude-code/scripts/build_agents.py generate \
...
python3 .agents/skills/create-agent-claude-code/scripts/build_agents.py validate \
  --source-dir .agents/agents --profiles .claude/pop-agent-profiles.json \
  --destination .claude/agents --runtime .claude/pop-agent-runtime.json
```
