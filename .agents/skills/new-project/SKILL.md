...
1. Create the standard anatomy and real copies of the workflow skills, including `yolo-critic` and `optimize-memory`. Create canonical `pop/specs/INDEX.md` whenever initial specs are accepted, migrating that collection atomically. Use the project's declared language and leave no placeholders.
